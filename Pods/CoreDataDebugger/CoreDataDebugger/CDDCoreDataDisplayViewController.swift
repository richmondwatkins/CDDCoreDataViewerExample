...
class CDDCoreDataDisplayViewController: UIViewController {
    ...
    @IBOutlet var objectListingSource: CDDObjectListingCollectionSource!
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet var tableSouce: CDDTableEntitySource!
...
extension CDDCoreDataDisplayViewController: CDDTableEntitySourceDelegate {
